...
export default function Profile() {
  ...
  const { data, isFetching, isLoading, hasNextPage, fetchNextPage } = trpc.user.getPlaylists.useInfiniteQuery(
    {},
    {
    ...
    <>
      ...
      <div className="max-w-[100ch] mx-auto my-4 flex flex-col gap-4">
        <div className="flex justify-between">
          <div>
            <div className="font-medium  text-2xl">{session.data?.user?.name}</div>
